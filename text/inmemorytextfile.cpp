...
void InMemoryTextFile::_InsertLine(const char* ptr, size_t current, size_t prev, PGScalar& max_length, double& current_width, PGTextBuffer*& current_buffer, lng& linenr) {
...
void InMemoryTextFile::_InsertText(const char* ptr, size_t current, size_t prev, PGScalar& max_length, double& current_width, PGTextBuffer*& current_buffer, lng& linenr) {
	if (current_buffer == nullptr) {
...
void InMemoryTextFile::ConsumeBytes(const char* buffer, size_t buffer_size,
...
void InMemoryTextFile::ConsumeBytes(const char* buffer, size_t buffer_size, size_t& prev, int& offset,
...
void InMemoryTextFile::VerifyPartialTextfile() {
#ifdef PANTHER_DEBUG
	lng total_lines = 0;
...
void InMemoryTextFile::VerifyTextfile() {
#ifdef PANTHER_DEBUG
	VerifyPartialTextfile();
	lng total_lines = 0;
